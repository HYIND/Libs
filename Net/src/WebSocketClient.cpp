...
Task<void> WebSocketClient::OnRecvBuffer(Buffer* buffer)
{
...
Task<void> WebSocketClient::OnConnectClose()
{
...
Task<void> WebSocketClient::ProcessPakage(WebSocketPackage* newpak)
{
